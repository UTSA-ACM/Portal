...
import NewMemberView from "../../components/member/NewMember";
...
const Admin: NextPage = () => {
	...
	const swapPage = (view: viewType) => {
		switch (view) {
			case viewType.dashboard:
				router.push("/member/", undefined, { shallow: true });
				break;
			...
			case viewType.newEvent:
				router.push("/member/events/new", undefined, { shallow: true });
				break;
		}
	};
	...
	} else if (path == "/member/temp/") {
		ElementToShow = MemberView;
	} else if (path == "/admin/") {
		ElementToShow = DashView;
	} else if (path == "/member/register/") {
		ElementToShow = EventView;
	}
